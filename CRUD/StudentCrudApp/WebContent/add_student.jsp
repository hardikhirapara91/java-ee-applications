					...
					<form action="Student" method="post" class="register-form">
						<div class="row">      
				        	<div class="col-md-4 col-sm-4 col-lg-4">
				            	...
				            	<input type="text" name="firstName" class="form-control" required="required" autofocus="autofocus">    
				           </div>            
				      	</div>
				      	<div class="row">      
				           	<div class="col-md-4 col-sm-4 col-lg-4">
				      	...
				      	<div class="row">      
							<div class="col-md-4 col-sm-4 col-lg-4">
				            	<label for="firstName">STANDARD</label>
				               	<input type="text" name="standard" class="form-control" required="required">    
				           	</div>            
				      	</div>
				      	<div class="row">      
				           <div class="col-md-4 col-sm-4 col-lg-4">
				      	...
				      	<div class="row">
				      		<div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
				      			<button class="btn btn-default logbutton" type="submit">Submit</button>
				      		</div>
				      	</div>
					</form> 
				</div>
